...
def train_model(X, y):
    ...
    model_filename = os.path.join(os.path.dirname(__file__), "svm_model.pkl")
...
def main():
    genuine_dir = r"DeepFake-Audio-Detection-MFCC\real_audio"
    deepfake_dir = r"DeepFake-Audio-Detection-MFCC\deepfake_audio"
